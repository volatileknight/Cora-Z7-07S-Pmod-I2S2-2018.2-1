...
module top #(
    ...
    //axis clock is 22.5792MHz, derived from 125MHz system clock by clk_wiz_0
    clk_wiz_0 m_clk (
        .clk_in1(clk),
        .axis_clk(axis_clk)
    );

    //lmem_bclk is 2.825MHz, derived from 125MHz system clock 
    //lmem_lrclk is 44.1kHz, derived from 125MHz system clock
    assign lmem_bclk = tx_sclk;
    assign lmem_lrclk = tx_lrck;
